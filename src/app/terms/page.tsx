            ...
            <div className="max-w-4xl mx-auto flex flex-col items-center">
                ...
                <div className="text-center mb-16">
                    ...
                    <p className="max-w-2xl mx-auto text-slate-500 font-medium text-lg md:text-xl text-center">
                        Simple rules to ensure a smooth and fair experience for every PixelCut user.
                    </p>
                </div>
                ...
                <div className="bg-slate-50/50 p-10 md:p-16 rounded-[3rem] border border-slate-100 shadow-sm relative overflow-hidden w-full">
                    ...
                    <div className="space-y-12 relative z-10 w-full">
                        <article className="prose prose-lg prose-slate max-w-none prose-headings:font-black prose-p:font-medium prose-p:text-slate-600 prose-p:leading-relaxed prose-h2:text-slate-900 prose-h2:text-3xl prose-h2:tracking-tight prose-h2:mb-8 prose-h2:pt-8 prose-ul:list-disc prose-ul:pl-6 prose-li:mb-2">
                            ...
                            <p>By using PixelCut AI at allbgremove.com, you agree to be bound by these terms. If you do not agree, please do not use our services. We may update these terms periodically to reflect new features or legal requirements.</p>

                            <h2 id="use-license">2. Permitted Use</h2>
                            <p>You may use PixelCut for personal or commercial projects. However, you must respect the following:</p>
                            <ul>
                            ...
                            <p>While we aim for 100% accuracy, AI results may vary depending on image complexity. PixelCut provides its service "as is" and "as available". We are not responsible for any data loss during transit or processing.</p>
                            ...
                            <p>For legal queries or formal complaints, please contact our legal team at <a href="mailto:legal@pixelcut.com" className="text-blue-600 hover:underline">legal@pixelcut.com</a>.</p>
                        </article>
