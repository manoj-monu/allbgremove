...
export default function AlbumMaker({ imageUrl, bgColor, customBgImage, onBack }: AlbumMakerProps) {
    ...
    const createCroppedImage = async () => {
        try {
            ...
            // Approximate target resolution based on physical CM mapped to a 300DPI equivalent scaling for printing crispness
            const localDPcm = 37.7952755906 * (300 / 96);
            const targetWidthPx = unit === "cm" ? photoWidth * localDPcm : photoWidth * 2.54 * localDPcm;
            const targetHeightPx = unit === "cm" ? photoHeight * localDPcm : photoHeight * 2.54 * localDPcm;
